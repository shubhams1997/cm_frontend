		...
		return (
			<form>
				<div className='form-group row'>
					...
					<div className='form-group col-sm-3'>
						<label>Case No</label>
						<input onChange={handleChange('caseNo')} type='text' className='form-control' value={caseNo} />
					</div>
				</div>
				...
				<div className='form-group row'>
					...
					<div className='form-group col-sm-2'>
						...
						<input onChange={handleChange('months')} type='text' className='form-control' value={months} />
					</div>
